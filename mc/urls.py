...
from .views import mi_cochinito_basePageView, mi_cochinito_inicioPageView, mi_cochinito_taller1PageView, mi_cochinito_taller2PageView, mi_cochinito_taller3PageView, mi_cochinito_taller4PageView, mi_cochinito_taller5PageView, mi_cochinito_taller6PageView, mi_cochinito_taller7PageView, mi_cochinito_taller8PageView, mi_cochinito_taller9PageView, mi_cochinito_financiamientoPageView

urlpatterns = [
    path('', mi_cochinito_inicioPageView.as_view(), name="mi_cochinito_inicio"),
    path('mi_cochinito_financiamiento', mi_cochinito_financiamientoPageView.as_view(), name="mi_cochinito_financiamiento"),
