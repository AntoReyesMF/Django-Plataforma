$('document').ready(function() {
  var quotes = [{
    ...
    quote: 'NO uses el efectivo: Si se te antojaron unos taquitos en la calle o comprar en el mercadito, lo mejor será que no uses tu tarjeta para evitar las comisiones Cuidado con los meses sin intereses: aunque uno de los mejores consejos que te podemos dar es busca las promociones, trata de no abusar de ellas, aunque podría parecer pagos pequeños, si abusas de ellos podría terminar pagando de más.',
